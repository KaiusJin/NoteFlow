...
function n(O, t, a) {
  return new p((e) => {
    let u = e.pos;
    for (; e.next != O && e.next >= 0 && (a || e.next != 38 && (e.next != 123 || e.peek(1) != 123)); )
      e.advance();
    e.pos > u && e.acceptToken(t);
  });
}
const d = /* @__PURE__ */ n(39, $, !1), f = /* @__PURE__ */ n(34, m, !1), C = /* @__PURE__ */ n(39, v, !0), T = /* @__PURE__ */ n(34, x, !0), A = /* @__PURE__ */ R.deserialize({
  version: 14,
  ...
  wrap: /* @__PURE__ */ l((O, t) => O.name == "InterpolationContent" ? o : null)
  ...
  top: "Attribute"
}), E = { parser: U }, N = { parser: y }, s = /* @__PURE__ */ c({ selfClosingTags: !0 });
function S(O) {
...
function _(O = {}) {
  ...
  return new P(t.language == s.language ? k : S(t.language), [t.support, t.language.data.of({
