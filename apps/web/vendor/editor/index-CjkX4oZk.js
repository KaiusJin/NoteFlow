...
const Z = 145, j = 1, E = 146, C = 147, f = 2, N = 148, V = 3, I = 4, X = [
  ...
  8287,
  12288
], D = 58, K = 40, b = 95, B = 91, c = 45, A = 46, J = 35, L = 37, H = 38, M = 92, ee = 10, Oe = 42;
function Q(e) {
...
const v = (e, r, i) => (O, a) => {
  ...
  if (X.includes(e.peek(-1))) {
    let { next: r } = e;
    (Q(r) || r == b || r == J || r == A || r == Oe || r == B || r == D && Q(e.peek(1)) || r == c || r == H) && e.acceptToken(Z);
  }
}), oe = new $((e) => {
  if (!X.includes(e.peek(-1))) {
    let { next: r } = e;
    if (r == L && (e.advance(), e.acceptToken(j)), Q(r)) {
      do
        e.advance();
      while (Q(e.next) || m(e.next));
      e.acceptToken(j);
    }
  }
}), le = W({
  ...
  "[ ]": t.squareBracket,
  "{ }": t.brace
}), ie = { __proto__: null, lang: 44, "nth-child": 44, "nth-last-child": 44, "nth-of-type": 44, "nth-last-of-type": 44, dir: 44, "host-context": 44, if: 90, url: 152, "url-prefix": 152, domain: 152, regexp: 152 }, ne = { __proto__: null, or: 104, and: 104, not: 112, only: 112, layer: 206 }, se = { __proto__: null, selector: 118, style: 124, layer: 202 }, de = { __proto__: null, "@import": 198, "@media": 210, "@charset": 214, "@namespace": 218, "@keyframes": 224, "@supports": 236, "@scope": 240, "@font-feature-values": 246 }, Qe = { __proto__: null, to: 243 }, ce = w.deserialize({
  version: 14,
  ...
  tokenizers: [te, oe, ae, re, 1, 2, 3, 4, new R("m~RRYZ[z{a~~g~aO$_~~dP!P!Qg~lO$`~~", 28, 152)],
  topRules: { StyleSheet: [0, 6], Styles: [1, 126] },
  dynamicPrecedences: { 94: 1 },
  specialized: [{ term: 147, get: (e) => ie[e] || -1 }, { term: 148, get: (e) => ne[e] || -1 }, { term: 4, get: (e) => se[e] || -1 }, { term: 28, get: (e) => de[e] || -1 }, { term: 146, get: (e) => Qe[e] || -1 }],
  tokenPrec: 2405
});
let u = null;
function p() {
  if (!u && typeof document == "object" && document.body) {
    let { style: e } = document.body, r = [], i = /* @__PURE__ */ new Set();
    for (let O in e)
      O != "cssText" && O != "cssFloat" && typeof e[O] == "string" && (/[A-Z]/.test(O) && (O = O.replace(/[A-Z]/g, (a) => "-" + a.toLowerCase())), i.has(O) || (r.push(O), i.add(O)));
    u = r.sort().map((O) => ({ type: "property", label: O, apply: O + ": " }));
  }
  return u || [];
}
const S = /* @__PURE__ */ [
  ...
  "yellow",
  "yellowgreen"
].map((e) => ({ type: "constant", label: e }))), $e = /* @__PURE__ */ [
  "a",
  "abbr",
  "address",
  "article",
  ...
  "u",
  "ul"
].map((e) => ({ type: "type", label: e })), ue = /* @__PURE__ */ [
  "@charset",
  "@color-profile",
  "@container",
  "@counter-style",
  ...
  "@supports",
  "@view-transition"
].map((e) => ({ type: "keyword", label: e })), d = /^(\w[\w-]*|-\w[\w-]*|)$/, pe = /^-(-[\w-]*)?$/;
function me(e, r) {
  var i;
...
const y = /* @__PURE__ */ new q(), je = ["Declaration"];
function ge(e) {
  for (let r = e; ; ) {
    if (r.type.isTop)
      return r;
...
function Y(e, r, i) {
  if (r.to - r.from > 4096) {
    ...
    if (O)
      return O;
    let a = [], o = /* @__PURE__ */ new Set(), l = r.cursor(F.IncludeAnonymous);
    if (l.firstChild())
      do
        for (let n of Y(e, l.node, i))
          o.has(n.label) || (o.add(n.label), a.push(n));
      while (l.nextSibling());
    return y.set(r, a), a;
  } else {
    let O = [], a = /* @__PURE__ */ new Set();
    return r.cursor().iterate((o) => {
      var l;
      if (i(o) && o.matchContext(je) && ((l = o.node.nextSibling) === null || l === void 0 ? void 0 : l.name) == ":") {
...
const Se = (e) => (r) => {
  let { state: i, pos: O } = r, a = _(i).resolveInner(O, -1), o = a.type.isError && a.from == a.to - 1 && i.doc.sliceString(a.from, a.to) == "-";
  if (a.name == "PropertyName" || (o || a.name == "TagName") && /^(Block|Styles)$/.test(a.resolve(a.to).name))
    return { from: a.from, options: p(), validFor: d };
  if (a.name == "ValueName")
    return { from: a.from, options: h, validFor: d };
  if (a.name == "PseudoClassName")
    return { from: a.from, options: S, validFor: d };
  if (e(a) || (r.explicit || o) && me(a, i.doc))
    return {
      from: e(a) || o ? a.from : O,
      options: Y(i.doc, ge(a), e),
      validFor: pe
    };
  if (a.name == "TagName") {
  ...
  if (a.name == "AtKeyword")
    return { from: a.from, options: ue, validFor: d };
  if (!r.explicit)
    return null;
  let l = a.resolve(O), n = l.childBefore(O);
  return n && n.name == ":" && l.name == "PseudoClassSelector" ? { from: O, options: S, validFor: d } : n && n.name == ":" && l.name == "Declaration" || l.name == "ArgList" ? { from: O, options: h, validFor: d } : l.name == "Block" || l.name == "Styles" ? { from: O, options: p(), validFor: d } : null;
}, he = /* @__PURE__ */ Se((e) => e.name == "VariableName"), P = /* @__PURE__ */ k.define({
  name: "css",
  parser: /* @__PURE__ */ ce.configure({
    props: [
      /* @__PURE__ */ x.add({
        Declaration: /* @__PURE__ */ T()
      }),
      /* @__PURE__ */ G.add({
...
function fe() {
  return new z(P, P.data.of({ autocomplete: he }));
}
export {
  fe as css,
  he as cssCompletionSource,
  P as cssLanguage,
