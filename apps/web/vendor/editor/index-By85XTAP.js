import { L as be, E as $, C as he } from "./index-C7qAncbV.js";
import { p as Te, s as Pe, t as b, E as xe, e as K, l as Ve, a as ye, L as we, i as ve, f as Xe, G as $e } from "./main-cdjAuFkF.js";
import { cssLanguage as J, css as _e } from "./index-CjkX4oZk.js";
import { typescriptLanguage as qe, jsxLanguage as Ce, tsxLanguage as ke, javascriptLanguage as M, javascript as Qe } from "./index-DllQj405.js";
...
const oe = 60, X = 62, E = 47, rt = 63, nt = 33, st = 45;
function j(e, a) {
  this.name = e, this.parent = a;
}
const ot = [R, le, ee, te, ae], it = new he({
  start: null,
  shift(e, a, r, l) {
...
const pt = Z("script", Ae, Ye), mt = Z("style", Me, Re), ft = Z("textarea", Ee, Ze), gt = Pe({
...
function ue(e = [], a = []) {
  ...
  return Te((i, u) => {
    ...
    if (f == re && s.length) {
      let p = i.node, d = p.firstChild, m = d && U(d, u), O;
      if (m) {
        for (let c of s)
          if (c.tag == m && (!c.attrs || c.attrs(O || (O = ie(d, u))))) {
            let S = p.lastChild, h = S.type.id == Ke ? S.from : p.to;
            if (h > d.to)
              return { parser: c.parser, overlay: [{ from: d.to, to: h }] };
          }
      }
    }
    if (o && f == ne) {
      ...
      if (d = p.firstChild) {
        ...
        if (m) for (let O of m) {
          ...
          let c = p.lastChild;
          if (c.type.id == A) {
            let S = c.from + 1, h = c.lastChild, T = c.to - (h && h.isError ? 0 : 1);
            if (T > S) return { parser: O.parser, overlay: [{ from: S, to: T }], bracketed: !0 };
          } else if (c.type.id == se)
            return { parser: O.parser, overlay: [{ from: c.from, to: c.to }] };
        }
      }
    }
    return null;
...
const V = ["_blank", "_self", "_top", "_parent"], C = ["ascii", "utf-8", "utf-16", "latin1", "latin1"], k = ["get", "post", "put", "delete"], Q = ["application/x-www-form-urlencoded", "multipart/form-data", "text/plain"], g = ["true", "false"], n = {}, bt = {
  a: {
    attrs: {
      href: null,
      ping: null,
...
class y {
  constructor(a, r) {
    this.tags = { ...bt, ...a }, this.globalAttrs = { ...Oe, ...r }, this.allTags = Object.keys(this.tags), this.globalAttrNames = Object.keys(this.globalAttrs);
  }
}
...
function L(e, a, r, l, t) {
  let s = /\s*>/.test(e.sliceDoc(t, t + 5)) ? "" : ">", o = x(r, r.name == "StartTag" || r.name == "TagName");
  return {
    from: l,
    to: t,
    options: ce(e.doc, o, a).map((i) => ({ label: i, type: "type" })).concat(B(e.doc, r).map((i, u) => ({
      label: "/" + i,
      apply: "/" + i + s,
      type: "type",
      boost: 99 - u
...
function Tt(e, a, r, l, t) {
  let s = x(r), o = s ? a.tags[P(e.doc, s)] : null, i = o && o.attrs ? Object.keys(o.attrs) : [], u = o && o.globalAttrs === !1 ? i : i.length ? i.concat(a.globalAttrNames) : a.globalAttrNames;
  return {
    from: l,
    to: t,
    options: u.map((f) => ({ label: f, type: "property" })),
    validFor: pe
  };
}
function Pt(e, a, r, l, t) {
  var s;
  let o = (s = r.parent) === null || s === void 0 ? void 0 : s.getChild("AttributeName"), i = [], u;
  if (o) {
    let f = e.sliceDoc(o.from, o.to), p = a.globalAttrs[f];
    if (!p) {
      let d = x(r), m = d ? a.tags[P(e.doc, d)] : null;
      p = (m == null ? void 0 : m.attrs) && m.attrs[f];
    }
    if (p) {
      let d = e.sliceDoc(l, t).toLowerCase(), m = '"', O = '"';
      /^['"]/.test(d) ? (u = d[0] == '"' ? /^[^"]*$/ : /^[^']*$/, m = "", O = e.sliceDoc(t, t + 1) == d[0] ? "" : d[0], d = d.slice(1), l++) : u = /^[^\s<>='"]*$/;
      for (let c of p)
        i.push({ label: c, apply: m + c + O, type: "constant" });
    }
  }
...
const Vt = /* @__PURE__ */ M.parser.configure({ top: "SingleExpression" }), fe = [
...
].concat(/* @__PURE__ */ de.map((e) => ({ name: e, parser: M.parser }))), Se = /* @__PURE__ */ we.define({
  name: "html",
  ...
  wrap: /* @__PURE__ */ ue(fe, ge)
});
function qt(e = {}) {
  let a = "", r;
  e.matchClosingTags === !1 && (a = "noMatch"), e.selfClosingTags === !0 && (a = (a ? a + " " : "") + "selfClosing"), (e.nestedLanguages && e.nestedLanguages.length || e.nestedAttributes && e.nestedAttributes.length) && (r = ue((e.nestedLanguages || []).concat(fe), (e.nestedAttributes || []).concat(ge)));
  let l = r ? Se.configure({ wrap: r, dialect: a }) : a ? v.configure({ dialect: a }) : v;
  return new ye(l, [
    v.data.of({ autocomplete: xt(e) }),
    e.autoCloseTags !== !1 ? yt : [],
    Qe().support,
    _e().support
  ]);
}
const H = /* @__PURE__ */ new Set(/* @__PURE__ */ "area base br col command embed frame hr img input keygen link meta param source track wbr menuitem".split(" ")), yt = /* @__PURE__ */ xe.inputHandler.of((e, a, r, l, t) => {
  if (e.composing || e.state.readOnly || a != r || l != ">" && l != "/" || !v.isActiveAt(e.state, a, -1))
    return !1;
  let s = t(), { state: o } = s, i = o.changeByRange((u) => {
    var f, p, d;
    let m = o.doc.sliceString(u.from - 1, u.to) == l, { head: O } = u, c = K(o).resolveInner(O, -1), S;
    if (m && l == ">" && c.name == "EndTag") {
      let h = c.parent;
      if (((p = (f = h.parent) === null || f === void 0 ? void 0 : f.lastChild) === null || p === void 0 ? void 0 : p.name) != "CloseTag" && (S = P(o.doc, h.parent, O)) && !H.has(S)) {
        let T = O + (o.doc.sliceString(O, O + 1) === ">" ? 1 : 0), w = `</${S}>`;
        return { range: u, changes: { from: O, to: T, insert: w } };
      }
    } else if (m && l == "/" && c.name == "IncompleteCloseTag") {
      let h = c.parent;
      if (c.from == O - 2 && ((d = h.lastChild) === null || d === void 0 ? void 0 : d.name) != "CloseTag" && (S = P(o.doc, h, O)) && !H.has(S)) {
        let T = O + (o.doc.sliceString(O, O + 1) === ">" ? 1 : 0), w = `${S}>`;
        return {
          range: Ve.cursor(O + w.length, -1),
          changes: { from: O, to: T, insert: w }
        };
      }
    }
    return { range: u };
