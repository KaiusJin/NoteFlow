import { L as k, E as A, C as N } from "./index-C2kqTU3Y.js";
import { s as I, t as p, E as Y, e as G, l as j, a as U, L as Z, i as B, f as D, G as M } from "./main-CClJD9LT.js";
...
function ge(e, t) {
  ...
  if (r && (r.to > t || r.lastChild.type.isError)) {
    ...
    return (s == null ? void 0 : s.name) == "StartTag" ? { type: "openTag", from: t, context: C(a) } : (s == null ? void 0 : s.name) == "StartCloseTag" && s.to <= t ? { type: "closeTag", from: t, context: a } : (s == null ? void 0 : s.name) == "Is" ? { type: "attrValue", from: t, context: r } : s ? { type: "attrName", from: t, context: r } : null;
...
function pe(e, t) {
  ...
  return (n) => {
    ...
    if (l == "openTag") {
      ...
      return {
        from: d,
        options: (i == null ? void 0 : i.attrs) || O,
        validFor: b
      };
    } else if (l == "attrValue") {
      let i = Se(c, S, d);
      if (!i)
        return null;
      let m = f[T(c, S)], g = ((m == null ? void 0 : m.attrValues) || r)[i];
