...
function o(Q, e) {
  return (n, a) => {
    O: for (let t = n.node.firstChild, c = 0, i = null; ; ) {
      ...
      e && t.name == e || t.name == "SpecList" ? (c++, i = t, t = t.firstChild) : (t.name == "DefName" && a(t, Q), t = t.nextSibling);
    }
    return !0;
  };
}
const cO = {
  FunctionDecl: /* @__PURE__ */ o("function"),
  VarDecl: /* @__PURE__ */ o("var", "VarSpec"),
  ConstDecl: /* @__PURE__ */ o("constant", "ConstSpec"),
  TypeDecl: /* @__PURE__ */ o("type", "TypeSpec"),
  ImportDecl: /* @__PURE__ */ o("constant", "ImportSpec"),
