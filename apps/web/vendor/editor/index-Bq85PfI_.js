...
}, Je = /* @__PURE__ */ pt({ commentTokens: { block: { open: "<!--", close: "-->" } } }), Ye = /* @__PURE__ */ new v(), We = /* @__PURE__ */ Nt.configure({
  props: [
...
const ar = /code|horizontalrule|html|link|comment|processing|escape|entity|image|mark|url/i, lr = /* @__PURE__ */ ht.domEventHandlers({
  paste: (t, e) => {
    var r;
